...
class DetallePedidoInline(admin.TabularInline):
    ...
    fields = ('platillo', 'cantidad', 'precio_formateado')
...
class PedidoAdmin(admin.ModelAdmin):
    list_display = ('id', 'cliente', 'habitacion', 'total_formateado', 'estado_color', 'fecha', 'link_ticket') # Cambiamos 'estado' por 'estado_color'
